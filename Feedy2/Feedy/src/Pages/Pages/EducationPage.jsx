        ...
        <div className={showQuiz ? "blurred-background" : ""}>
                    ...
                    >
                        <div className="tutorial-window">
                            ...
                            <p>
                                ...
                                the nutrition basics. You can click close to dismiss this message.
                            </p>
                    ...
                    <div className="modal-window">
                        ...
                        {!isQuizComplete ? (
                            ...
                            <div>
                                ...
                                <button className={"close-button"} onClick={handleCloseQuiz}>Close Quiz</button>
                            </div>
                        )}
                    </div>
                </div>
            ...
            <div className={"content-box-what"}>
                <div className={"pop-up"}>
                    ...
                    <button className={"edu-button"} onClick={() => setShowProtein(true)}>Protein</button>
                    <button className={"edu-button"} onClick={() => setShowCarbs(true)}>Carbs</button>
                    <button className={"edu-button"} onClick={() => setShowFats(true)}>Fats</button>
                    <button className={"edu-button"} onClick={() => setShowCalories(true)}>Calories</button>
                </div>
            </div>
            ...
            <div className={"pop-up2"}>
                ...
                <button className={"edu-button2"} onClick={() => setShowProtein(true)}>Protein</button>
                <button className={"edu-button2"} onClick={() => setShowCarbs(true)}>Carbs</button>
                <button className={"edu-button2"} onClick={() => setShowFats(true)}>Fats</button>
                <button className={"edu-button2"} onClick={() => setShowCalories(true)}>Calories</button>
                <button className={"edu-button2"} onClick={() => setShowCalories(true)}>Calories</button>
                <button className={"edu-button2"} onClick={() => setShowCalories(true)}>Calories</button>
                <button className={"edu-button2"} onClick={() => setShowCalories(true)}>Calories</button>
                <button className={"edu-button2"} onClick={() => setShowCalories(true)}>Calories</button>
            ...
            {showProtein && (
                <div className="modal-container" onClick={handleClickOutsideModal}>
                    <div className="modal-window">
                        ...
                        <img src="path/to/protein-image.jpg" alt="Protein" className="modal-image"/>
                        <p>Protein is essential for building muscle and tissue repair.</p>
            ...
            {showCarbs && (
                <div className="modal-container" onClick={handleClickOutsideModal}>
                    <div className="modal-window">
                        <h3>Carbohydrates Information</h3>
                        <img src="path/to/carbs-image.jpg" alt="Carbs" className="modal-image"/>
                        <p>Carbs provide energy for the body to function properly.</p>
                        <button onClick={handleCloseModal}>Close</button>
                    </div>
                </div>
            )}
            ...
            {showFats && (
                <div className="modal-container" onClick={handleClickOutsideModal}>
                    <div className="modal-window">
                        <h3>Fats Information</h3>
                        <img src="path/to/fats-image.jpg" alt="Fats" className="modal-image"/>
                        <p>Fats are important for brain function and energy storage.</p>
                        <button onClick={handleCloseModal}>Close</button>
                    </div>
                </div>
            )}
            ...
            {showCalories && (
                <div className="modal-container" onClick={handleClickOutsideModal}>
                    <div className="modal-window">
                        ...
                        <img src="path/to/calories-image.jpg" alt="Calories" className="modal-image"/>
            ...
            <div className={"content-box-pyramid "}>
                ...
                <button className={"pyramid-button"} onClick={() => setShowCalories(true)}>What is this Pyramid here ?
                </button>
            </div>
        </div>
    );
