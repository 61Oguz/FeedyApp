                ...
                <div>
                    <div className="sideBar-info">
                        <p style={{
                            color: "white",
                            fontFamily: "time"
                        }}>{capitalizeFirstLetter(user.userName.split(" ")[0])} &nbsp; |&nbsp; Age: {user.age}  &nbsp;  </p>
                        <p style={{
                            color: "white",
                            fontFamily: "time"
                        }}>{user.sex} &nbsp; | &nbsp;{user.height}cm &nbsp; {user.weight}kg </p> <p style={{
                            color: "white",
                            fontFamily: "time"
                        }}>D. Calories: {dailyCalorieNeed} </p>
                    </div>
                    <hr className="sidebar-divider"/>

                    <button className="sidebar-buttons" onClick={() => navigate("/welcome")}>
                        Home
                    </button>

                    <button className="sidebar-buttons" onClick={() => navigate("/profile")}>
                        Profile
                    </button>

                    <button className="sidebar-buttons" onClick={() => navigate("/foodlog")}>
                        FoodLog
                    </button>
